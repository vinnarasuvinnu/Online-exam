                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-6">                     
                                <h3 class="text-center">Create Question</h3>
                                    ...
                                    <form action="createp.php" method="POST" id="cat1" class="form-horizontal" style="background-color: #fff"  enctype="multipart/form-data">
                                        <div class="text-center">
                                                <label>Question paper name</label>
                                                <input type="text" name="qname" class="form-control" required> 
                                                <label>Catogery</label>

                                                <select class="form-control" name="paper" style="height: 40px;">
