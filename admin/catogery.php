...
<div class="container">
        <div class="row" style="margin-top: 200px;">
                        ...
                        <div class="col-sm-6 col-lg-6">                     
                                ...
                                <h3 class="text-center">Create Catogery</h3>
                                    <form action="cat_db.php" method="POST" id="cat1" class="form-horizontal" style="background-color: #fff"  enctype="multipart/form-data">
                                        <div class="text-center">
                                                <label>Please Enter your catogery</label>
